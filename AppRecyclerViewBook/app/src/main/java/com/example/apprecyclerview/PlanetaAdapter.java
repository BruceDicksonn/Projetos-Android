...
public class PlanetaAdapter extends RecyclerView.Adapter<PlanetaAdapter.PlanetasViewHolder> {
    ...
    public PlanetasViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.activity_adapter_planeta, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(final PlanetasViewHolder holder, @SuppressLint("RecyclerView") final int position) {
